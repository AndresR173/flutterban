...
mixin _$KColumn {
  ...
  ObservableList<KTask> get children => throw _privateConstructorUsedError;
...
abstract class $KColumnCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, ObservableList<KTask> children});
}
...
class _$_KColumn implements _KColumn {
  ...
  final String title;
  @override
  final ObservableList<KTask> children;
...
abstract class _KColumn implements KColumn {
  const factory _KColumn(
      ...
      required final ObservableList<KTask> children}) = _$_KColumn;

  @override
  String get title;
  @override
  ObservableList<KTask> get children;
  @override
  @JsonKey(ignore: true)
  _$$_KColumnCopyWith<_$_KColumn> get copyWith =>
